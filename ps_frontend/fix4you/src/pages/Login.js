...
const RegisterChoice = () => {
    return (
        ...
        <div class="bg-gray-200">
            ...
            <div class="p-8 w-1/3 bg-gray-100 shadow-lg rounded-lg bg-cover bg-center mt-10 sm:mx-auto sm:w-full sm:max-w-sm mb-40">
                <form class="space-y-6" action="#" method="POST">
                    ...
                    <div>
                        <div class="flex items-center justify-between">
                            ...
                            <div class="text-sm">
                                <a href="#" class="font-semibold text-yellow-500 mx-2 hover:underline">Forgot password?</a>
                            </div>
                        </div>
                ...
                <p class="mt-10 text-center text-sm text-gray-800">
                    ...
                    <a href="/RegisterChoice" class="font-semibold leading-6 text-yellow-500 mx-2 hover:underline">Register</a>
                </p>
                <br/>
            </div>
            <Footer />
