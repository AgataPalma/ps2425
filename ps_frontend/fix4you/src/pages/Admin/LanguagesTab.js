...
const LanguagesTab = () => {
    ...
    const handleSaveCategory = async () => {
        ...
        try {
            if (modalType === 'add') {
                ...
                const response = await axiosInstance.put(`/languages/${currentCategory.id}`, {
                    name,
                });
                fetchCategories();
            }
            ...
            console.error('Erro ao salvar languages:', error);
        }
    };
    ...
    const handleDeleteCategory = async (id) => {
        try {
            ...
            console.error('Erro ao apagar languages:', error);
        }
    };
    ...
    return (
        <div className="p-6">
            <h2 className="text-2xl font-bold mb-4 text-yellow-600">Gestão de Línguas</h2>
            <button
